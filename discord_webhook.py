...
webhook_url = 'https://discord.com/api/webhooks/773729877417000971/ZcYGmEhlJMOmxVDU3gja2JTiA9C7xDZ99qkKsAibGqf8BCOe382Nj5EPkF-uCgT3KINQ'
...
def send_msg(class_name,status,start_time,end_time):
    ...
    # Attaches a footer
    webhook.set_footer(text='-- Colton Meador')
